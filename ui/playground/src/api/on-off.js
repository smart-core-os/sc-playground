...
/**
 * @param {string} name
 * @param {ResourceValue<OnOff.AsObject>} [resource]
 * @returns {ResourceValue<OnOff.AsObject>}
 */
export function pullOnOff(name, resource = null) {
  return pullResource('OnOff', resource, endpoint => {
