...
/**
 * @param {string} name
 * @param {ResourceValue<OpenClosePositions.AsObject>} [resource]
 * @returns {ResourceValue<OpenClosePositions.AsObject>}
 */
export function pullOpenClosePositions(name, resource = null) {
  return pullResource('OpenClose.Positions', resource, endpoint => {
